  ...
  return (
    <div>
      ...
      <section
        ...
        className={`section ${currentSection === "dashboard" ? "active" : ""}`}
      >
        <Dashboard switchSection={switchSection} setDetailId={setDetailId} />
      </section>
      <section
        id="section-create"
        className={`section ${currentSection === "create" ? "active" : ""}`}
      >
        <CreatePACT switchSection={switchSection} />
      </section>
      <section
        id="section-experiments"
        className={`section ${currentSection === "experiments" ? "active" : ""}`}
      >
        <Experiments
          switchSection={switchSection}
          setDetailId={setDetailId}
          onOpenLog={openLogModal}
          onOpenReflection={openReflectionModal}
        />
      </section>
      <section
        id="section-timeline"
      ...
      {showReflectionModal && (
        <ReflectionModal onClose={closeReflectionModal} />
      )}
      {detailId && (
      ...
      {showOnboarding && (
        <Onboarding onDone={() => dispatch({ type: "DISMISS_ONBOARDING" })} />
      )}
      {toast && (
